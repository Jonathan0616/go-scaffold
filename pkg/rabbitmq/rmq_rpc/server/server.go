...
import (
	...
	rmqrpc "go-scaffold/pkg/rabbitmq/rmq_rpc"
	"time"
)
...
// CallHandler
type CallHandler func(delivery *amqp.Delivery) (interface{}, error)
...
func (s *Server) serveCall(d *amqp.Delivery) {
	...
	if err != nil {
		...
		s.logger.Error(err, "rmq_rpc - Server - serveCall - callHandler")
		return
	}
